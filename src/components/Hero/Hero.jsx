  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-1/2 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-12 top-1/2 -translate-y-1/2 w-[65vw] md:w-[30vw] max-w-[480px] pointer-events-none z-0"
        style={{ y }}
      >
        <img
          src={heroImage}
